<?php include('../PHP/register_php.php')?>
<!DOCTYPE html>
  ...
  <body>
    <header>
      ...
      <div class="navbar">
        ...
        <a href="gettingtoknowyou.php">TELL US MORE ABOUT YOU</a>
      ...
      <section id="showcase">
        ...
        <form action="register.php" method="POST">
          ...
          <button type="submit" name = "registerButton" class="button">REGISTER</button>
